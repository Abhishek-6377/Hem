...
const reviews = [
  {
    name: "Better Intent, Better Leads",
    role: "SaaS",
  ...
  {
    name: "More Than Keyword Stuffing",
    role: "Technology",
  ...
  (_, copyIndex) =>
    reviews
      .map((review, reviewIndex) => ({
        ...review,
        loopIndex:
          copyIndex * reviews.length + reviewIndex,
        realIndex: reviewIndex,
      }))
).flat();

export default function ServReviews() {
  ...
  */
  ...
  /*
    Convert any index into the review range.
  */
      ...
      <div className="relative mx-auto max-w-[1250px] px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
            ...
            Real feedback should talk about real problems,
            useful content, and the difference it made,
            not just say “great service.”
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-xs font-medium text-[#203f7a]">
