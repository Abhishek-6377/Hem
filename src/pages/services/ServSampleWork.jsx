...
const projects = [
  ...
  },
  {
    ...
    category: "Blog Writing",
    image:
      "https://images.unsplash.com/photo-1505751172876-fa1923c5c528?auto=format&fit=crop&w=1000&q=85",
...
export default function ServSampleWork() {
  ...
  */
  const initializeCarousel = () => {
    ...
    const startingIndex = MIDDLE_COPY * TOTAL;
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-3xl px-5 text-center">
          ...
          <motion.p
            ...
            "
          >
            See how our blog writing services adapt to
            different industries, audiences, search intent,
            and brand voices while keeping every article
            useful and engaging.
          </motion.p>
        </div>
